...
class SourceControlConfigurationClient(MultiApiClientMixin, _SDKClient):
    ...
    def flux_config_operation_status(self):
        """Instance depends on the API version:
           ...
           * 2021-06-01-preview: :class:`FluxConfigOperationStatusOperations<azure.mgmt.kubernetesconfiguration.v2021_06_01_preview.aio.operations.FluxConfigOperationStatusOperations>`
        """
        api_version = self._get_api_version('flux_config_operation_status')
        if api_version == '2021-06-01-preview':
            from ..v2021_06_01_preview.aio.operations import FluxConfigOperationStatusOperations as OperationClass
        else:
    ...
    def flux_configurations(self):
        """Instance depends on the API version:
           ...
           * 2021-06-01-preview: :class:`FluxConfigurationsOperations<azure.mgmt.kubernetesconfiguration.v2021_06_01_preview.aio.operations.FluxConfigurationsOperations>`
        """
        api_version = self._get_api_version('flux_configurations')
        if api_version == '2021-06-01-preview':
            from ..v2021_06_01_preview.aio.operations import FluxConfigurationsOperations as OperationClass
        else:
    ...
    def operation_status(self):
        """Instance depends on the API version:
           ...
           * 2021-06-01-preview: :class:`OperationStatusOperations<azure.mgmt.kubernetesconfiguration.v2021_06_01_preview.aio.operations.OperationStatusOperations>`
        """
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2021-06-01-preview: :class:`Operations<azure.mgmt.kubernetesconfiguration.v2021_06_01_preview.aio.operations.Operations>`
        """
