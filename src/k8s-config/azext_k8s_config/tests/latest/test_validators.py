...
class TestValidateKeyTypes(unittest.TestCase):
    ...
    def test_ecdsa_private_key(self):
        ...
        protected_settings = _get_protected_settings(ecdsa_key, '', '', '')
        self.assertEqual('sshPrivateKey' in protected_settings, True)
    ...
    def test_ed25519_private_key(self):
        ...
        protected_settings = _get_protected_settings(ed25519_key, '', '', '')
        self.assertEqual('sshPrivateKey' in protected_settings, True)
...
class TestValidateK8sNaming(unittest.TestCase):
    def test_long_operator_namespace(self):
        ...
        with self.assertRaises(InvalidArgumentValueError) as cm:
            validators._validate_operator_namespace(namespace)
        self.assertEqual(str(cm.exception), err)
    ...
    def test_long_operator_instance_name(self):
        ...
        with self.assertRaises(InvalidArgumentValueError) as cm:
            validators._validate_operator_instance_name(namespace)
        self.assertEqual(str(cm.exception), err)
    ...
    def test_long_config_name(self):
        ...
        with self.assertRaises(InvalidArgumentValueError) as cm:
            validators._validate_configuration_name(config_name)
        self.assertEqual(str(cm.exception), err)
...
class TestValidateURLWithParams(unittest.TestCase):
    def test_ssh_private_key_with_ssh_url(self):
        validators._validate_url_with_params('git@github.com:jonathan-innis/helm-operator-get-started-private.git', True, False, False)

    def test_ssh_known_hosts_with_ssh_url(self):
        validators._validate_url_with_params('git@github.com:jonathan-innis/helm-operator-get-started-private.git', False, True, False)
    ...
    def test_https_auth_with_ssh_url(self):
        ...
        with self.assertRaises(MutuallyExclusiveArgumentError) as cm:
            validators._validate_url_with_params('git@github.com:jonathan-innis/helm-operator-get-started-private.git', False, False, True)
        self.assertEqual(str(cm.exception), err)
...
class TestValidateKnownHosts(unittest.TestCase):
    def test_valid_known_hosts(self):
        ...
        validators._validate_known_hosts(known_hosts_encoded)
