...
class Extension(ProxyResource):
    ...
    :vartype error_info: ~azure.mgmt.kubernetesconfiguration.models.ErrorDetail
...
class ExtensionType(msrest.serialization.Model):
    ...
    :ivar cluster_types: Cluster types. Possible values include: "connectedClusters",
     "managedClusters".
    :vartype cluster_types: str or ~azure.mgmt.kubernetesconfiguration.models.ClusterTypes
    :ivar supported_scopes: Extension scopes.
    :vartype supported_scopes: ~azure.mgmt.kubernetesconfiguration.models.SupportedScopes
    """
...
class ExtensionTypeList(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.kubernetesconfiguration.models.ExtensionType]
...
class ExtensionVersionList(msrest.serialization.Model):
    ...
    :type versions:
     list[~azure.mgmt.kubernetesconfiguration.models.ExtensionVersionListVersionsItem]
    :param next_link: The link to fetch the next page of Extension Types.
    :type next_link: str
    :ivar system_data: Metadata pertaining to creation and last modification of the resource.
    :vartype system_data: ~azure.mgmt.kubernetesconfiguration.models.SystemData
...
class FluxConfiguration(ProxyResource):
    ...
    :type scope: str or ~azure.mgmt.kubernetesconfiguration.models.ScopeType
    ...
    :param source_kind: Source Kind to pull the configuration data from. Possible values include:
     "GitRepository".
    :type source_kind: str or ~azure.mgmt.kubernetesconfiguration.models.SourceKindType
    ...
    :type git_repository: ~azure.mgmt.kubernetesconfiguration.models.GitRepositoryDefinition
    :param kustomizations: Array of kustomizations used to reconcile the artifact pulled by the
     source type on the cluster.
    :type kustomizations: list[~azure.mgmt.kubernetesconfiguration.models.KustomizationDefinition]
    ...
    :ivar sync_state: Combined status of the Flux Kubernetes resources created by the
     ...
     "non-compliant", "syncing". Default value: "syncing".
    :vartype sync_state: str or ~azure.mgmt.kubernetesconfiguration.models.SyncStateType
...
class FluxConfigurationsList(msrest.serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.kubernetesconfiguration.models.FluxConfiguration]
...
class GitRepositoryDefinition(msrest.serialization.Model):
    ...
    :type url: str
    :param timeout: The maximum time to attempt to reconcile the cluster git repository source with
     the remote.
    :type timeout: str
    :param sync_interval: The interval at which to re-reconcile the cluster git repository source
     with the remote.
    :type sync_interval: str
    :param repository_ref: The source reference for the GitRepository object.
    :type repository_ref: ~azure.mgmt.kubernetesconfiguration.models.RepositoryRefDefinition
    ...
    :type https_user: str
    :param auth_ref_override: Name of a local secret on the Kubernetes cluster to use as the
     authentication secret rather than the managed or user-provided configuration secrets.
    :type auth_ref_override: str
    """

    _attribute_map = {
        'url': {'key': 'url', 'type': 'str'},
        'timeout': {'key': 'timeout', 'type': 'str'},
        'sync_interval': {'key': 'syncInterval', 'type': 'str'},
        ...
        'auth_ref_override': {'key': 'authRefOverride', 'type': 'str'},
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.sync_interval = kwargs.get('sync_interval', None)
        ...
        self.auth_ref_override = kwargs.get('auth_ref_override', None)
...
class KustomizationDefinition(msrest.serialization.Model):
    ...
    :param timeout: The maximum time to attempt to reconcile the Kustomization on the cluster.
    :type timeout: str
    :param sync_interval: The interval at which to re-reconcile the Kustomization on the cluster.
    :type sync_interval: str
    :param retry_interval: The interval at which to re-reconcile the Kustomization on the cluster
    ...
    :type validation: str or ~azure.mgmt.kubernetesconfiguration.models.KustomizationValidationType
    ...
    _attribute_map = {
        ...
        'timeout': {'key': 'timeout', 'type': 'str'},
        'sync_interval': {'key': 'syncInterval', 'type': 'str'},
        'retry_interval': {'key': 'retryInterval', 'type': 'str'},
